...
class FedReserveSpider(scrapy.Spider):
    ...
    def parse_content(self, response):
        ...
        content_html = response.css('#article .col-sm-8, #content .col-sm-8, .article__content').get()
        ...
        doc_type = "speech" if "Speech" in source_type or "Testimony" in source_type else "statement"
